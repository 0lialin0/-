...
import cn.wtkj.charge_inspect.mvp.presenter.LawsNewsPresenter;
import cn.wtkj.charge_inspect.mvp.presenter.LawsNewsPresenterImpl;
 ...
 */
public class LawsNewsActivity extends MvpBaseActivity<LawsNewsPresenter> implements
        LawsNewsView {
    ...
    @Override
    protected LawsNewsPresenter createPresenter() {
        return new LawsNewsPresenterImpl();
    }
