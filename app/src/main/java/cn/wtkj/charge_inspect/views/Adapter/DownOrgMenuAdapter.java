 ...
 */
public class DownOrgMenuAdapter extends RecyclerView.Adapter<DownOrgMenuAdapter.ViewHolder> {
    private List<ViewOrganizationData.MData.info> mList;
    private Context mContext;
    private OnItemClickListener onItemClickListener;

    public DownOrgMenuAdapter(List<ViewOrganizationData.MData.info> mList, Context context){
        this.mList = mList;
